...
{
    public partial class frmInDSDDHChuaCoPhieuNhap : Form
    {
        public frmInDSDDHChuaCoPhieuNhap()
        {
            InitializeComponent();
        }

        private void frmInDSDDHChuaCoPhieuNhap_Load(object sender, EventArgs e)
        {
        ...
        {
            Report_SP_DSDDHCHUACOPN rp = new Report_SP_DSDDHCHUACOPN();
